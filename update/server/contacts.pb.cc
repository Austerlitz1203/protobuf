...
const uint32_t TableStruct_contacts_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::contacts::PeopleInfo, _impl_.birthday_),
...
const char descriptor_table_protodef_contacts_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "hone_number\030\001 \001(\t\"R\n\nPeopleInfo\022\014\n\004name\030"
  "\001 \001(\t\022\020\n\010birthday\030\004 \001(\005\022\036\n\005phone\030\003 \003(\0132\017"
  ".contacts.PhoneJ\004\010\002\020\003\"2\n\010Contacts\022&\n\010con"
  "tacts\030\001 \003(\0132\024.contacts.PeopleInfob\006proto"
  "3"
  ;
static ::_pbi::once_flag descriptor_table_contacts_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_contacts_2eproto = {
    false, false, 201, descriptor_table_protodef_contacts_2eproto,
    "contacts.proto",
