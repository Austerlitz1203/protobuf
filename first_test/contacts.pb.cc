...
PROTOBUF_CONSTEXPR PeopoInfo::PeopoInfo(
    ::_pbi::ConstantInitialized): _impl_{
...
struct PeopoInfoDefaultTypeInternal {
  PROTOBUF_CONSTEXPR PeopoInfoDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~PeopoInfoDefaultTypeInternal() {}
  union {
    PeopoInfo _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PeopoInfoDefaultTypeInternal _PeopoInfo_default_instance_;
...
const uint32_t TableStruct_contacts_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::contacts::PeopoInfo, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::contacts::PeopoInfo, _impl_.name_),
  PROTOBUF_FIELD_OFFSET(::contacts::PeopoInfo, _impl_.age_),
  PROTOBUF_FIELD_OFFSET(::contacts::PeopoInfo, _impl_.phone_),
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_contacts_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\016contacts.proto\022\010contacts\"\035\n\005Phone\022\024\n\014p"
  "hone_number\030\001 \001(\t\"F\n\tPeopoInfo\022\014\n\004name\030\001"
  " \001(\t\022\013\n\003age\030\002 \001(\005\022\036\n\005phone\030\003 \003(\0132\017.conta"
  "cts.Phone\"1\n\010Contacts\022%\n\010contacts\030\001 \003(\0132"
  "\023.contacts.PeopoInfob\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_contacts_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_contacts_2eproto = {
    false, false, 188, descriptor_table_protodef_contacts_2eproto,
    "contacts.proto",
...
class PeopoInfo::_Internal {
 public:
};

PeopoInfo::PeopoInfo(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:contacts.PeopoInfo)
}
PeopoInfo::PeopoInfo(const PeopoInfo& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  PeopoInfo* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  // @@protoc_insertion_point(copy_constructor:contacts.PeopoInfo)
}

inline void PeopoInfo::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
PeopoInfo::~PeopoInfo() {
  // @@protoc_insertion_point(destructor:contacts.PeopoInfo)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void PeopoInfo::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.phone_.~RepeatedPtrField();
  _impl_.name_.Destroy();
}

void PeopoInfo::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void PeopoInfo::Clear() {
// @@protoc_insertion_point(message_clear_start:contacts.PeopoInfo)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* PeopoInfo::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "contacts.PeopoInfo.name"));
        } else
          goto handle_unusual;
        continue;
      // int32 age = 2;
...
uint8_t* PeopoInfo::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:contacts.PeopoInfo)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:contacts.PeopoInfo)
  return target;
}

size_t PeopoInfo::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:contacts.PeopoInfo)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData PeopoInfo::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    PeopoInfo::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*PeopoInfo::GetClassData() const { return &_class_data_; }


void PeopoInfo::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<PeopoInfo*>(&to_msg);
  auto& from = static_cast<const PeopoInfo&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:contacts.PeopoInfo)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void PeopoInfo::CopyFrom(const PeopoInfo& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:contacts.PeopoInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool PeopoInfo::IsInitialized() const {
  return true;
}

void PeopoInfo::InternalSwap(PeopoInfo* other) {
  using std::swap;
  auto* lhs_arena = GetArenaForAllocation();
  auto* rhs_arena = other->GetArenaForAllocation();
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
...
::PROTOBUF_NAMESPACE_ID::Metadata PeopoInfo::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_contacts_2eproto_getter, &descriptor_table_contacts_2eproto_once,
...
template<> PROTOBUF_NOINLINE ::contacts::PeopoInfo*
Arena::CreateMaybeMessage< ::contacts::PeopoInfo >(Arena* arena) {
  return Arena::CreateMessageInternal< ::contacts::PeopoInfo >(arena);
}
